                    ...
                    <div class="space-y-6">
                        <div class="bg-gradient-primary p-6 rounded-modern-lg text-white">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="bg-white p-4 rounded-lg shadow-modern cursor-pointer hover:scale-105 transition-all duration-300 flex flex-col items-center justify-center min-h-[100px]">
                                    <div class="w-12 h-12 bg-white rounded-lg shadow-modern mb-2"></div>
                                    <span class="text-sm font-medium text-gray-800">Biały</span>
                                </div>
                                <div class="bg-blue-500 p-4 rounded-lg shadow-modern cursor-pointer hover:scale-105 transition-all duration-300 flex flex-col items-center justify-center min-h-[100px]">
                                    <div class="w-12 h-12 bg-blue-500 rounded-lg shadow-modern mb-2"></div>
                                    <span class="text-sm font-medium text-white">Niebieski</span>
                                </div>
                                <div class="bg-green-500 p-4 rounded-lg shadow-modern cursor-pointer hover:scale-105 transition-all duration-300 flex flex-col items-center justify-center min-h-[100px]">
                                    <div class="w-12 h-12 bg-green-500 rounded-lg shadow-modern mb-2"></div>
                                    <span class="text-sm font-medium text-white">Zielony</span>
                                </div>
                                <div class="bg-purple-500 p-4 rounded-lg shadow-modern cursor-pointer hover:scale-105 transition-all duration-300 flex flex-col items-center justify-center min-h-[100px]">
                                    <div class="w-12 h-12 bg-purple-500 rounded-lg shadow-modern mb-2"></div>
                        ...
                        <div class="bg-gradient-secondary p-6 rounded-modern-lg text-white">
                            ...
                            <div class="space-y-4">
                                <div class="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20 cursor-pointer hover:bg-white/20 transition-all duration-300">
