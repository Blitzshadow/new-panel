...
// Inicjalizacja modułów personalizacji
require_once __DIR__ . '/modules/personalization/branding.php';
require_once __DIR__ . '/modules/personalization/dashboard-widgets.php';
require_once __DIR__ . '/modules/personalization/dashboard-layout.php';
require_once __DIR__ . '/modules/personalization/shortcuts.php';

// Inicjalizacja modułów content
require_once __DIR__ . '/modules/content/posts.php';
?>
            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="#personalization" class="sidebar-link sidebar-toggle" data-toggle="submenu-personalization">
                        <svg class="w-4 h-4" style="width: 25px; height: 25px;" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                ...
                <li>
                    <a href="#media" class="sidebar-link sidebar-toggle" data-toggle="submenu-media">
                        <svg class="w-4 h-4" style="width: 25px; height: 25px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg>
                ...
                <li>
                    <a href="#coupons" class="sidebar-link sidebar-toggle" data-toggle="submenu-coupons">
                        <svg class="w-4 h-4" style="width: 25px; height: 25px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect x="3" y="7" width="18" height="10" rx="2"/><path d="M7 7v10"/></svg>
                ...
                <li>
                    <a href="#reports" class="sidebar-link sidebar-toggle" data-toggle="submenu-reports">
                        <svg class="w-4 h-4" style="width: 25px; height: 25px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M3 3v18h18"/><path d="M7 13l3 3 7-7"/></svg>
                ...
                <li>
                    <a href="#customers" class="sidebar-link sidebar-toggle" data-toggle="submenu-customers">
                        <svg class="w-4 h-4" style="width: 25px; height: 25px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="8" r="4"/><path d="M6 20v-2a6 6 0 0 1 12 0v2"/></svg>
                ...
                <li>
                    <a href="#forms" class="sidebar-link sidebar-toggle" data-toggle="submenu-forms">
                        <svg class="w-4 h-4" style="width: 25px; height: 25px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M8 8h8v8H8z"/></svg>
                ...
                <li>
                    <a href="#settings" class="sidebar-link sidebar-toggle" data-toggle="submenu-settings">
                        <svg class="w-4 h-4" style="width: 25px; height: 25px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>
                ...
                <li>
                    <a href="#notifications" class="sidebar-link">
                        <svg class="w-4 h-4" style="width: 25px; height: 25px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9"/></svg>
